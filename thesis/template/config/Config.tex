...
\newcommand{\source}[1]{{\vspace{-5mm}\footnotesize\textsf{\textbf{Source:}} \textsf{#1}\par}}
...
\newcommand{\anhangsverzeichnis}{\mtcaddsection{\subsection*{List of Appendices \@mkboth{FKT}{FKT}}}\@starttoc{fk}\newpage}
...
\input{template/config/Abkuerzungen}
